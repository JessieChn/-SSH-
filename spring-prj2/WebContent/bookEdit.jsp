...
<h2><strong>修改图书信息</strong></h2>
<h3>当前修改的图书ID：<s:property value="id"/></h3>
<s:form cssClass="form-horizontal"  action="bookUpdate" method="post" namespace="/" theme="simple">
<s:textfield name="book.id" value="%{id}" cssClass="zhebi"/>
  <div class="form-group">
    <label class="col-md-2 control-label">请输入书名</label>
    <div class="col-md-6">
      <s:textfield cssClass="form-control" name="book.name" label="请输入书名" onBlur="checkBookName()"  value="%{name}"/>
    </div>
 ...
 <div class="form-group">
    ...
    <div class="col-md-6">
      <img class="img-rounded" height="100px" width="100px"  src="images/<s:property value="picture"/>">  <br>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <sx:textarea cssClass="form-control" rows="3" name="book.description"  label="请输入图书的描述" value="%{description}"></sx:textarea>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <s:textfield cssClass="form-control" name="book.price" label="请输入图书的价钱"  onBlur="checkBookPrice()" value="%{price}"/>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <s:textfield cssClass="form-control" name="book.writer"  label="图书作者"  onBlur="checkBookWriter()" value="%{writer}"/>
    </div>
